...
class EngagementNode(Node):
    ...
    def __init__(
        ...
        self.declare_parameter(
            'reference_frame', 'rgb_head_center', ParameterDescriptor(
        ...
        self.declare_parameter(
            'field_of_view', 90., ParameterDescriptor(
        ...
        self.declare_parameter(
            'observation_window', 4., ParameterDescriptor(
    ...
    def on_activate(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self.last_had_active_people = None
    ...
    def get_tracked_humans(self):
        ...
        if self.active_persons:
            ...
            if self.last_had_active_people is not False:
                self.get_logger().info('There are no active people around')
                self.last_had_active_people = False
        ...
        if self.active_persons and self.last_had_active_people is not True:
            self.get_logger().info('Active people detected')
            self.last_had_active_people = True
